...
public class RandomSurferRandomFree
{
    public static void main(String[] args)
    {
        ...
        for (int t = 0; t < T; t++)
        {
            // Calculate the sum of probabilities in the current row.
            double sum = 0.0;
            
            for (int j = 0; j < N; j++)
                sum += p[page][j];
            
            // Make one random move, now sum holds the sum of probabilities in the row.
